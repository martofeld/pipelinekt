...
fun DslContext<Step>.archiveArtifacts(artifacts: String, fingerprint: Boolean, allowEmptyArchive: Boolean = false, onlyIfSuccessful: Boolean = false) =
    archiveArtifacts(artifacts.strDouble(), fingerprint, allowEmptyArchive, onlyIfSuccessful)

fun DslContext<Step>.archiveArtifacts(artifacts: Var.Literal.Str, fingerprint: Boolean, allowEmptyArchive: Boolean = false, onlyIfSuccessful: Boolean = false) {
